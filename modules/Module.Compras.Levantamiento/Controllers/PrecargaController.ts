...
export default class PrecargaController {
	private static instance: PrecargaController | null;
	...
	public static getInstance(): PrecargaController {
		if (!PrecargaController.instance) {
			PrecargaController.instance = new PrecargaController();
		}

		return PrecargaController.instance;
	}

	public static destroyInstance(): void {
		PrecargaController.instance = null;
	}
